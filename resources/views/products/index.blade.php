    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="max-w-7xl mx-auto sm:px-4 lg:px-4 ">
            ...
            <div class="bg-white shadow-sm rounded-md sm:rounded-lg p-6 mb-8 flex flex-row justify-between items-center">
                ...
                <a href="{{ route('products.create') }}" class="font-bold px-5 py-2.5 bg-[#7d5f12] text-white rounded-lg">
                    Add New
                </a>
            </div>
                    ...
                    <table class="w-full text-md text-left text-gray-500 rounded-xl overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b border-gray-200 hover:bg-gray-50 font-medium">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-lg text-gray-900">{{ $product->name }}</div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-row gap-x-3 justify-end">
                                        <a href="{{ route('products.stockedit', $product) }}" class="font-medium text-blue-600 hover:underline">Edit Stock</a> |
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="text-center py-4 text-gray-400">Belum ada product yang diinput</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
